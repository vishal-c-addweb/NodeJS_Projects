...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst express_1 = __webpack_require__(/*! express */ \"express\");\nconst cartApiController_1 = __importDefault(__webpack_require__(/*! ../controllers/cartApiController */ \"./src/controllers/cartApiController.ts\"));\nconst authenticate_1 = __importDefault(__webpack_require__(/*! ../middleware/authenticate */ \"./src/middleware/authenticate.ts\"));\nconst router = (0, express_1.Router)();\nrouter.post('/', authenticate_1.default, cartApiController_1.default.addToCart);\nrouter.put('/:id', authenticate_1.default, cartApiController_1.default.updateCart);\nrouter.delete('/:id', authenticate_1.default, cartApiController_1.default.deleteCart);\nrouter.get('/:userId', authenticate_1.default, cartApiController_1.default.getCart);\nrouter.get('/', authenticate_1.default, cartApiController_1.default.getAllCart);\nexports[\"default\"] = router;\n\n\n//# sourceURL=webpack://nodeecommerce/./src/routes/cart.ts?");
...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst express_1 = __webpack_require__(/*! express */ \"express\");\nconst orderApiController_1 = __importDefault(__webpack_require__(/*! ../controllers/orderApiController */ \"./src/controllers/orderApiController.ts\"));\nconst authenticate_1 = __importDefault(__webpack_require__(/*! ../middleware/authenticate */ \"./src/middleware/authenticate.ts\"));\nconst router = (0, express_1.Router)();\nrouter.post('/', authenticate_1.default, orderApiController_1.default.addOrder);\nrouter.put('/:id', authenticate_1.default, orderApiController_1.default.updateOrder);\nrouter.delete('/:id', authenticate_1.default, orderApiController_1.default.deleteOrder);\nrouter.get('/:userId', authenticate_1.default, orderApiController_1.default.getOrder);\nrouter.get('/', authenticate_1.default, orderApiController_1.default.getAllOrder);\nrouter.get('/income', authenticate_1.default, orderApiController_1.default.getMonthlyIncome);\nexports[\"default\"] = router;\n\n\n//# sourceURL=webpack://nodeecommerce/./src/routes/order.ts?");
...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst express_1 = __webpack_require__(/*! express */ \"express\");\nconst productApiController_1 = __importDefault(__webpack_require__(/*! ../controllers/productApiController */ \"./src/controllers/productApiController.ts\"));\nconst authenticate_1 = __importDefault(__webpack_require__(/*! ../middleware/authenticate */ \"./src/middleware/authenticate.ts\"));\nconst router = (0, express_1.Router)();\nrouter.post('/', authenticate_1.default, productApiController_1.default.addProduct);\nrouter.put('/:id', authenticate_1.default, productApiController_1.default.updateProduct);\nrouter.delete('/:id', authenticate_1.default, productApiController_1.default.deleteProduct);\nrouter.get('/:id', productApiController_1.default.getProduct);\nrouter.get('/', productApiController_1.default.getAllProduct);\nexports[\"default\"] = router;\n\n\n//# sourceURL=webpack://nodeecommerce/./src/routes/product.ts?");
